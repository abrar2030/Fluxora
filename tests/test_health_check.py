...
class TestHealthCheck(unittest.TestCase):
    ...
    def test_health_check_healthy(self, mock_disk_usage, mock_virtual_memory, mock_cpu_percent):
    ...
    @patch('src.utils.health_check.psutil.virtual_memory')
    @patch('src.utils.health_check.psutil.disk_usage')
    def test_health_check_degraded_system(self, mock_disk_usage, mock_virtual_memory, mock_cpu_percent):
    ...
    @patch('src.utils.health_check.psutil.virtual_memory')
    @patch('src.utils.health_check.psutil.disk_usage')
    def test_health_check_degraded_dependency(self, mock_disk_usage, mock_virtual_memory, mock_cpu_percent):
        ...
        self.assertEqual(health_status["dependencies"]["items"][0]["status"], HealthStatus.DEGRADED)
    
    @patch('src.utils.health_check.psutil.cpu_percent')
    @patch('src.utils.health_check.psutil.virtual_memory')
    @patch('src.utils.health_check.psutil.disk_usage')
    def test_health_check_unhealthy_dependency(self, mock_disk_usage, mock_virtual_memory, mock_cpu_percent):
        ...
        # Verify dependencies
        self.assertEqual(health_status["dependencies"]["status"], HealthStatus.UNHEALTHY)
        self.assertEqual(health_status["dependencies"]["items"][0]["status"], HealthStatus.UNHEALTHY)
    
    @patch('src.utils.health_check.psutil.cpu_percent')
    @patch('src.utils.health_check.psutil.virtual_memory')
    @patch('src.utils.health_check.psutil.disk_usage')
    def test_health_check_dependency_exception(self, mock_disk_usage, mock_virtual_memory, mock_cpu_percent):
        ...
        self.assertEqual(health_status["dependencies"]["items"][0]["status"], HealthStatus.UNHEALTHY)
        self.assertEqual(health_status["dependencies"]["items"][0]["details"]["error"], "Unexpected error")
    ...
    def test_add_health_check_endpoints(self):
        ...
        health_check.check_health = Mock(return_value={"status": HealthStatus.UNHEALTHY})
