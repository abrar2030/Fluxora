...
from fluxora.core.transaction_coordinator import TransactionCoordinator, TransactionStatus, TransactionParticipant
...
class TestTransactionCoordinator(unittest.TestCase):
    ...
    def test_register_participant(self):
        ...
        self.assertIn(participant, self.coordinator.transactions[transaction_id]["participants"])
    ...
    def test_prepare_transaction_success(self):
        ...
        self.assertEqual(self.coordinator.transactions[transaction_id]["status"], TransactionStatus.PREPARED)
    ...
    def test_prepare_transaction_failure(self):
        ...
        # Verify the transaction status
        self.assertEqual(self.coordinator.transactions[transaction_id]["status"], TransactionStatus.ABORTED)
    ...
    def test_commit_transaction_success(self):
        ...
        self.coordinator.transactions[transaction_id]["status"] = TransactionStatus.PREPARED
        ...
        # Verify the transaction status
        self.assertEqual(self.coordinator.transactions[transaction_id]["status"], TransactionStatus.COMMITTED)
    ...
    def test_commit_transaction_not_prepared(self):
        ...
        # Verify the transaction status
        self.assertEqual(self.coordinator.transactions[transaction_id]["status"], TransactionStatus.CREATED)
