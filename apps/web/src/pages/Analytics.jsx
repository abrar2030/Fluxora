                  ...
                  <Box sx={{ height: 400 }}>
                    <ResponsiveContainer width="100%" height="100%">
                      ...
                      >
                        ...
                        <Tooltip />
                        <Legend />
                        <Bar dataKey="consumption" name="Consumption (kWh)" fill={theme.palette.primary.main} />
                      </BarChart>
                    </ResponsiveContainer>
                  </Box>
                )}
                  ...
                  <Box sx={{ height: 400 }}>
                    <ResponsiveContainer width="100%" height="100%">
                      ...
                      >
                        ...
                        <Tooltip />
                        <Legend />
                        <Bar dataKey="heating" name="Heating" stackId="a" fill={theme.palette.error.main} />
                        <Bar dataKey="cooling" name="Cooling" stackId="a" fill={theme.palette.info.main} />
                        <Bar dataKey="other" name="Other" stackId="a" fill={theme.palette.success.main} />
                      </BarChart>
                    </ResponsiveContainer>
                  </Box>
                )}
